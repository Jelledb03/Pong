...
HD_PWD='C:/Vivado/Pong/Pong.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Overkoepelend.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Overkoepelend.tcl -notrace
