...
HD_PWD='C:/Vivado/Pong/Pong.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log Overkoepelend.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Overkoepelend.tcl
